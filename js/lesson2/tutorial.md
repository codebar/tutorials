...
For example, if we wanted to set a timer on an online ticket outlet, we could count the timer down in the loop and while it hasn't reached zero, the option to buy the ticket can still be available.
